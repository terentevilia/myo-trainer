        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-xs font-semibold leading-relaxed text-black/50">
              Первые заполненные повторы станут ориентиром для следующих мини-подходов.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex gap-3">
        ...
        <div>
          <p className="text-sm font-black leading-snug">
            Стоп-сигнал: повторы начали падать. Мио-сет завершен. Дальше продолжать не нужно — это уже лишний объем.
          </p>
          ...
          <p className="mt-3 text-xs font-semibold leading-relaxed text-red-900/70">
            В мио-сетах падение повторений — сигнал, что нужный стимул уже набран. Продолжать дальше обычно не нужно.
          </p>
